...
Aliasing of member names (functions and variables) seems necessary for having a CamelCase standard library, that is realized as a shallow but "perfect" wrapper for the C++ standard library.
...
- [Fixing C++ "wrong defaults"](/more/other-ideas/#circle-sean-baxter)
